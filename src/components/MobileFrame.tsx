...
export default function MobileFrame({
  ...
  return (
    <div className="min-h-screen bg-zinc-100/40 flex flex-col items-center justify-center p-0 md:p-6 font-sans">
      ...
      <div className="w-full max-w-md min-h-screen md:min-h-[840px] md:max-h-[880px] bg-white md:rounded-[36px] overflow-hidden flex flex-col relative shadow-xl md:border md:border-zinc-200/80">
